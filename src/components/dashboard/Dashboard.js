    ...
    return (
      <div id="dashboard">
        ...
        <DemoModal ref={(r) => { this.demoModal = r; }}>
          Thanks for checking out TensorCI, LatticeAI's internal CI tool for building and deploying machine learning models. Use the side tabs on your left to browse the latest model deployments, their predictions, and much more.
        </DemoModal>
        <BannerComp/>
      </div>
    );
